...
type AwsBasicsStackProps struct {
	awscdk.StackProps
}

func NewAwsBasicsStack(scope constructs.Construct, id string, props *AwsBasicsStackProps) awscdk.Stack {
	...
	myFunction := awslambda.NewFunction(stack, jsii.String("AwsBasicsFunction"), &awslambda.FunctionProps{
	...
	registerResource.AddMethod(jsii.Sprintf("POST"), integration, nil)
...
func main() {
	...
	NewAwsBasicsStack(app, "AwsBasicsStack", &AwsBasicsStackProps{
		awscdk.StackProps{
			Env: env(),
		},
	})
